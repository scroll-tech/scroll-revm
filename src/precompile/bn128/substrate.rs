// Copied from https://github.com/bluealloy/revm/blob/v75/crates/precompile/src/bn128/substrate.rs under MIT License
use super::{PrecompileError, FQ2_LEN, FQ_LEN, G1_LEN, SCALAR_LEN};
